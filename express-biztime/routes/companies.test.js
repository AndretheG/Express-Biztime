...
describe("GET /", function () {
  ...
  test("It should respond with arry of companies", async function () {
...
describe("GET /apple", function () {
  ...
  test("It should return 404 for no-such-company", async function () {
    const response = await requrest(app).get("/companies/blargh");
...
describe("POST /", function () {
  ...
  test("It should resturn 500 for conflict", async function () {
    const response = await request(app)
        .post("/companies")
